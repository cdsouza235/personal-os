...
class Phase14CSupervisedSmokeDocsTest(unittest.TestCase):
    def test_runbook_records_source_contract_and_cli(self) -> None:
        ...
        required_phrases = (
            ...
            "personalos.cli phase14c wide-net-calendar-transcript-template --json",
            "personalos.cli phase14c wide-net-calendar-transcript-validate --input-file",
            "personalos.cli phase14c wide-net-execution-handoff --json",
            "personalos.cli phase14c wide-net-evidence-template --json",
            "personalos.cli phase14c wide-net-evidence-validate --input-file",
            "personalos.cli phase14c wide-net-evidence-crosscheck --calendar-transcript-file",
            "personalos.cli phase14c wide-net-evidence-rehearsal --json",
            ...
            "fillable sanitized post-run evidence shape",
            "not accepted evidence until a separately approved run",
            "redacted pass/block report",
            "evidence crosscheck compares one sanitized calendar transcript",
            "evidence rehearsal command constructs synthetic sanitized inputs",
    ...
    def test_connectivity_doc_records_live_smoke_evidence(self) -> None:
        ...
        required_phrases = (
            ...
            "marker, precheck count, and calendar create count agree",
